...
public class CardGameGUI13 extends JFrame implements ActionListener {
	...
	/*
	 * The below are used to tell whether or not the player is playing Thirteens
	 */
	static boolean thirteens;
	
	//Getter for the boolean thirteens
	public static boolean getThirteens() {
		return thirteens;
	}
	
	//Setters
	public static void setThirteensTrue() {
		thirteens = true;
	}
	public static void setThirteensFalse() {
		thirteens = false;
	}
	...
	private static final String[] BUY = {"BOOYAH!", "MEH..."};//Options for the player to choose from
	 ...
	 */
	public CardGameGUI13(Board gameBoard) {
		board = gameBoard;
		totalWins = 0;
		totalGames = 0;
		noResize();
		setThirteensTrue();//Sets Thirteens true since player is currently playing the game
		 ...
		 */
		  ...
		  menuItem2.addActionListener(new java.awt.event.ActionListener() {
			  public void actionPerformed(java.awt.event.ActionEvent evt) {
				  Window.msg2("The THIRTEENS game rules: "
				  		+ "\n Match pairs that add up to 13 and click 'replace'"
				  		+ "\nA single King can also be eliminated!"
		  ...
		  menuItem3.addActionListener(new java.awt.event.ActionListener() {
			  public void actionPerformed(java.awt.event.ActionEvent evt) {
				  ...
				  disposeThis();//Dispose Thirteens game
				  TensGUIRunner.tens();//Start Tens game
			  }
		  });
		  
		  //Second option in the drop down menu
		  menuItem4 = new JMenuItem();
		  menuItem4.setText("ELEVENS Game");//Elevens game
		  menuItem4.addActionListener(new java.awt.event.ActionListener() {
			  public void actionPerformed(java.awt.event.ActionEvent evt) {//If this button is clicked
					if(Set.getBoughtElevens() == false) {//If the player has not bought the Thirteens game yet
					...
					if(x==1) {//If they say they do not want to exchange coins
						...
						disposeThis();//Dispose the Thirteens game JFrame
						repaint(); 
						TensGUIRunner.elevens();//Starts the Elevens game
						}
		  ...
		  menu2.add(menuItem4);//Adds the Elevens button to DLC
	...
	public void repaint() {
		...
		this.setTitle("THIRTEENS - Coins: "+ coins);
		pack();
		panel.repaint();
